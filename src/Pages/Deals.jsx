  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 rounded-lg">
        ...
        <Link to='/deals/favorite-products' >
          {" "}
          <img
